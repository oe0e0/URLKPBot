...
class BotMessage(object):
    common_text = "\n\n<u>If you are facing any problem, so report at @KPCallBot</u>"
    ...
    start_msg = f"<b>Hi, I am URL_UploaderBot Created by @KP_TG .</b>\n{help_msg}"
    not_joined_community = f"<b>To use this bot, you need to Join our Channel .</b>{common_text}"
